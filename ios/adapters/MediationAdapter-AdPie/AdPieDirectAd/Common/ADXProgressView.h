...
@interface ADXProgressView : UIView <CAAnimationDelegate>
 ...
 */
@property (nonatomic, copy) void (^fillChangedBlock)(ADXProgressView *progressView, BOOL filled, BOOL animated);
 ...
 *  Example usage would be to invert the colors on your centralView
 */
@property (nonatomic, copy) void (^didSelectBlock)(ADXProgressView *progressView);
 ...
 */
@property (nonatomic, copy) void (^progressChangedBlock)(ADXProgressView *progressView, CGFloat progress);
 ...
 */
@property (nonatomic, copy) void (^didLongPressBlock)(ADXProgressView *progressView);
