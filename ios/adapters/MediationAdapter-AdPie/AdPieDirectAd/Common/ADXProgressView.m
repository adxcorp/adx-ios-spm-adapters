...
NSString *const ADXProgressViewProgressAnimationKey = @"ADXProgressViewProgressAnimationKey";

@interface ADXCircularProgressView : UIView
...
@interface ADXProgressView () <UIGestureRecognizerDelegate>

@property (strong) ADXCircularProgressView *progressView;
@property (assign) int valueLabelProgressPercentDifference;
@property (strong) NSTimer *valueLabelUpdateTimer;
@property (strong) NSTimer *longPressTimer;

@end

@implementation ADXProgressView
...
- (void)sharedSetup {
    self.progressView = [[ADXCircularProgressView alloc] initWithFrame:self.bounds];
    self.progressView.shapeLayer.fillColor = [UIColor blackColor].CGColor;
...
- (void)animateToProgress:(CGFloat)progress {
    ...
    [self.progressView.layer addAnimation:animation forKey:ADXProgressViewProgressAnimationKey];
    ...
    self.valueLabelUpdateTimer = [NSTimer scheduledTimerWithTimeInterval:timerInterval repeats:YES block:^(NSTimer * _Nonnull timer) {
        [weakSelf onValueLabelUpdateTimer:timer];
    }];
...
- (void)stopAnimation {
    ...
    [self.progressView.layer removeAnimationForKey:ADXProgressViewProgressAnimationKey];
...
#pragma mark - ADXCircularProgressView

@implementation ADXCircularProgressView
