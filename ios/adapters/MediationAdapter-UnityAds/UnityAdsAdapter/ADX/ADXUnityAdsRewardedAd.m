//
//  ADXUnityAdsRewardedAd.m
//  ADXLibrary-UnityAds
//
//  Copyright © 2017 AD(X) Corp. All rights reserved.
//

#import "ADXUnityAdsRewardedAd.h"

#import "ADXUnityAdsAdapter.h"
#import <ADXLibrary/ADXAdError.h>

@interface ADXUnityAdsRewardedAd () <UnityAdsLoadDelegate, UnityAdsShowDelegate>

@property (nonatomic, copy) NSString *placementId;
@property (nonatomic, assign) BOOL adLoaded;
@end

@implementation ADXUnityAdsRewardedAd
