//
//  ADXFyberInterstitialAd.m
//  ADXLibrary-Fyber
//
//  Copyright © 2017 AD(X) Corp. All rights reserved.
//

#import "ADXFyberInterstitialAd.h"

#import "ADXFyberAdapter.h"

#import <ADXLibrary/ADXAdError.h>

@interface ADXFyberInterstitialAd () <IAUnitDelegate, IAVideoContentDelegate, IAMRAIDContentDelegate>
...
@implementation ADXFyberInterstitialAd
...
- (void)IAVideoContentController:(IAVideoContentController * _Nullable)contentController videoInterruptedWithError:(NSError *)error {
    ADXLogDebug(@"IAVideoContentController:videoInterruptedWithError: %@", error.description);
    self.adLoaded = NO;
